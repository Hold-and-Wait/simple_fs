...
* File: fsLowDriver.c
*
* Description: This is the driver program for the file system 
*
**************************************************************/
...
int main (int argc, char *argv[]){
	...
	int retVal = 0;
	retVal = beginFSInit(filename, &volumeSize, &blockSize, sbPtr, bitmap_vec); 	// Mounts volume and formats File System
